        ...
        public class RadarRenderer
        {
            ...
            public void Draw(IMyTextSurface surface)
            {
                ...
                using (var frame = surface.DrawFrame())
                {
                    ...
                    {
                        Position = center,
                        Color = Settings.Global.BackgroundColor,
                    };
            ...
            {
                var projectionAngle = Settings.Global.ProjectionAngle;
            ...
            private void DrawPlane(MySpriteDrawFrame frame, Vector2 center, Vector2 planeSize, Vector2 viewportSize, float scale)
            {
                ...
                var sprite = new MySprite(SpriteType.TEXTURE, "SquareSimple")
                {
                    ...
                    Color = Settings.Global.TitlebarColor,
                };
                ...
                sprite = new MySprite(SpriteType.TEXT, title)
                {
                    ...
                    RotationOrScale = scale * Settings.Global.TitleScale,
                    Color = Settings.Global.TextColor,
                    Alignment = TextAlignment.CENTER,
                    FontId = Settings.Global.Font,
                };
                ...
                sprite = new MySprite(SpriteType.TEXTURE, "Circle")
                {
                    Position = center,
                    Size = planeSize * 0.5f,
                    Color = Settings.Global.PlaneColor,
                };
                ...
                sprite = new MySprite(SpriteType.TEXTURE, "Triangle")
                {
                    ...
                    Size = iconSize,
                    Color = Settings.Global.LineColor,
                };

                frame.Add(sprite);

                if (Settings.Global.DrawQuadrants)
                {
                    var quadrantLine = planeSize.X * quadrantLineDirection;
                    var lineWidth = QUADRANT_LINE_WIDTH * scale;
                    var quadrantLineColor = Settings.Global.LineColor * 0.5f;
            ...
            {
                var textSize = scale * Settings.Global.TextScale;
                var viewportHalfSize = viewportSize * 0.5f;
                ...
                enemySprite.Color = Settings.Global.EnemyCountColor;
                ...
                friendlySprite.Color = Settings.Global.FriendlyCountColor;
